...
Tu trouveras la <a href="https://contrib.spip.net/5080" target="_blank" rel="noopener noreferrer">documentation complète de la syntaxe sur Spip-contrib</a>.', # MODIF
	...
	'option_afficher_si_remplissage_uniquement_label_case' => 'Masquer les saisies uniquement lors du remplissage', # MODIF
	'option_attention_explication' => 'Un message plus important que l’explication.',
	'option_attention_label' => 'Avertissement',
	'option_attribut_title_label' => 'Valeur en attribut title', # MODIF
	...
	'option_choix_alternatif_label' => 'Proposer un choix alternatif', # MODIF
	'option_choix_alternatif_label_defaut' => 'Autre choix',
	'option_choix_alternatif_label_label' => 'Label de ce choix alternatif',
	'option_choix_destinataires_explication' => 'Liste d’auteurs et d’autrices pour une sélection de destinataires par l’internaute, à défaut ce sera la personne qui a installé le site.', # MODIF
	...
	'option_datas_explication' => 'Tu dois indiquer un choix par ligne sous la forme "cle|Label du choix"', # MODIF
	...
	'option_datas_sous_groupe_explication' => 'Tu dois indiquez un choix par ligne sous la forme "cle|Label" du choix. <br />Tu peux indiquer le début d’un sous-groupe sous la forme "*Titre du sous-groupe". Pour finir un sous-groupe tu peux en entamez un autre, ou bien mettre une ligne contenant unique "/*".', # MODIF
	...
	'option_type_choix_tous' => 'Mettre <strong>toutes</strong> ces personnes en destinataires. L’internaute n’aura aucun choix.', # MODIF
	'option_type_choix_un' => 'Permettre à l’internaute de choisir <strong>une seule personne</strong> (sous forme de liste déroulante).', # MODIF
	'option_type_choix_un_radio' => 'Permettre à l’internaute de choisir <strong>une seule  </strong> personne (sous forme de liste à puce).', # MODIF
	...
	// S
	'saisie_auteurs_explication' => 'Permet de sélectionner un auteur, une autrice, ou plusieurs', # MODIF
	'saisie_auteurs_titre' => 'Autrices et auteurs', # MODIF
	...
	'saisie_selecteur_rubrique_article_titre' => 'Sélecteur d’article ou rubrique', # MODIF
	...
	'saisie_selection_titre' => 'Liste déroulante', # MODIF
