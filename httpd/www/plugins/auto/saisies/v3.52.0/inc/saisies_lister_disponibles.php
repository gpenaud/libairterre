...
function saisies_recuperer_heritage($saisie, $saisies_repertoire = 'saisies') {
	...
	if (is_string($heritage)) {
		return saisies_recuperer_heritage_ancienne_syntaxe($saisie, $heritage, $saisies_repertoire);
	}
...
/**
 * Permet à une saisie d'hériter des options et valeur par défaut d'une autre saisies
 * Fonction pour l'ancienne syntaxe. Sera supprimé dans la version 4.0.0 du plugin
 * @param string $saisie la saisie
 * @param string $type_mere le type de la saisie dont on hérite
 * @param string $saisies_repertoire = 'saisies'
 * @return array
 **/
function saisies_recuperer_heritage_ancienne_syntaxe($saisie, $type_mere, $saisies_repertoire = 'saisies') {
