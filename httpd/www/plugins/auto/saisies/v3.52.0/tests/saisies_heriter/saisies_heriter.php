...
// On a besoin du plugin .yaml
if (!test_plugin_actif('yaml')) {
	die ('<dl>Ce test n\'a de sens qu\'avec le plugin YAML activé</dl>');
}
...
function essais_saisies_charger_infos(){
	$essais = array (
		...
		'0' => array(
			...
			1 => 'enfant_pasfusion',
			2 => 'tests/saisies/ancienne_syntaxe'
		),
		'1' => array(
			0 => array (
				'titre' => 'titi',
		...
		'4' => array(
			...
			1 => 'enfant_pasfusion',
			2 => 'tests/saisies/nouvelle_syntaxe'
		),
		'5' => array(
			0 => array (
				'titre' => 'titi',
