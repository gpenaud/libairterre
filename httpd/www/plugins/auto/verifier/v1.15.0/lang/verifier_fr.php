...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'erreur_slug_longueur_maxi' => '@nb_max@ caractère(s) au maximum (actuellement @nb@).',
	'erreur_slug_normaliser_suggerer' => 'Essayez « @valeur@ ».',
	...
	'option_regex_negation_label_case' => 'Vérifier que la réponse <strong>ne correspond pas</strong> au masque',
	...
	'option_slug_normaliser_explication' => 'Normaliser les caractères accentués, la ponctuation, etc.<br>Exemple : « Ô, toi, l’écureuil ! » devient « o_toi_l_ecureuil »',
	'option_slug_normaliser_label' => 'Normaliser la valeur',
	'option_slug_normaliser_suggerer_explication' => 'Par défaut la normalisation s’opère silencieusement en arrière-plan. Vous pouvez en faire une simple suggestion pour permettre de garder la main.',
	'option_slug_normaliser_suggerer_label' => 'Ne faire qu’une suggestion.',
	'option_slug_separateur_explication' => 'Caractère employé pour séparer les mots.',
	...
	'type_slug_description' => 'Un slug est un court texte utilisable pour décrire et identifier une ressource. Il ne contient que des caractères alphanumériques ou un séparateur (le caractère « _ »).',
	'type_taille' => 'Taille',
