...
include_once_check(_ROOT_PLUGINS.'z-core/zcore_pipelines.php');
include_once_check(_ROOT_PLUGINS.'court-circuit/courtcircuit_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.52.0/saisies_pipelines.php');
$inc=true;
}
$val = minipipe('cvtmulti_styliser', $val);
$val = minipipe('vertebres_styliser', $val);
$val = minipipe('Zcore_styliser', $val);
$val = minipipe('courtcircuit_styliser', $val);
...
include_once_check(_ROOT_PLUGINS.'oembed/oembed_pipelines.php');
$inc=true;
}
$val = minipipe('f_recuperer_fond', $val);
$val = minipipe('oembed_recuperer_fond', $val);
$val = minipipe('zcore_recuperer_fond', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'pages/base/pages_tables.php');
include_once_check(_ROOT_PLUGINS.'mailsubscribers/base/mailsubscribers.php');
include_once_check(_ROOT_PLUGINS.'mailshot-v1/base/mailshot.php');
include_once_check(_ROOT_PLUGINS.'newsletters-v1/base/newsletters.php');
include_once_check(_ROOT_PLUGINS.'agenda-v3/base/agenda_evenements.php');
include_once_check(_ROOT_PLUGINS.'auto/import_ics/v4.8.0/base/import_ics.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/base/breves.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/base/medias.php');
include_once_check(_ROOT_PLUGINS.'auto/accesrestreint/v4.2.2/base/accesrestreint.php');
$inc=true;
}
...
$val = minipipe('import_ics_declarer_tables_objets_sql', $val);
$val = minipipe('breves_declarer_tables_objets_sql', $val);
$val = minipipe('medias_declarer_tables_objets_sql', $val);
$val = minipipe('accesrestreint_declarer_tables_objets_sql', $val);
...
$val = minipipe('import_ics_declarer_tables_interfaces', $val);
$val = minipipe('breves_declarer_tables_interfaces', $val);
$val = minipipe('medias_declarer_tables_interfaces', $val);
$val = minipipe('oembed_declarer_tables_interfaces', $val);
...
include_once_check(_ROOT_PLUGINS.'agenda-v3/agenda_pipelines.php');
...
$val = minipipe('agenda_accueil_encours', $val);
...
include_once_check(_ROOT_PLUGINS.'mailshot-v1/mailshot_pipelines.php');
$inc=true;
}
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/cextras/v3.14.2/cextras_pipelines.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS.'mailsubscribers/mailsubscribers_pipelines.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'organiseur/organiseur_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/couleur_objet/v0.6.1/couleur_objet_pipelines.php');
$inc=true;
}
$val = minipipe('compagnon_affiche_droite', $val);
$val = minipipe('organiseur_affiche_droite', $val);
$val = minipipe('couleur_objet_affiche_droite', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'compagnon/compagnon_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/medias_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/accesrestreint/v4.2.2/accesrestreint_pipelines.php');
$inc=true;
}
$val = minipipe('compagnon_affiche_gauche', $val);
$val = minipipe('medias_affiche_gauche', $val);
$val = minipipe('accesrestreint_affiche_gauche', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'sites/sites_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'statistiques/stats_pipelines.php');
include_once_check(_ROOT_PLUGINS.'pages/pages_pipelines.php');
include_once_check(_ROOT_PLUGINS.'pages/pages_pipelines.php');
include_once_check(_ROOT_PLUGINS.'agenda-v3/agenda_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/import_ics/v4.8.0/import_ics_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/breves_pipelines.php');
...
$val = minipipe('import_ics_affiche_milieu', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'urls_etendues/urls_pipeline.php');
include_once_check(_ROOT_PLUGINS.'pages/pages_autorisations.php');
include_once_check(_ROOT_PLUGINS.'mailsubscribers/mailsubscribers_autorisations.php');
include_once_check(_ROOT_PLUGINS.'mailshot-v1/mailshot_autorisations.php');
include_once_check(_ROOT_PLUGINS.'newsletters-v1/newsletters_autorisations.php');
include_once_check(_ROOT_PLUGINS.'agenda-v3/agenda_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/cextras/v3.14.2/inc/cextras_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/import_ics/v4.8.0/import_ics_autorisations.php');
...
include_once_check(_ROOT_PLUGINS.'auto/accesrestreint/v4.2.2/inc/accesrestreint_autoriser.php');
$inc=true;
}
...
$val = minipipe('import_ics_autoriser', $val);
...
include_once_check(_ROOT_PLUGINS.'agenda-v3/base/agenda_evenements.php');
include_once_check(_ROOT_PLUGINS.'auto/import_ics/v4.8.0/base/import_ics.php');
include_once_check(_ROOT_PLUGINS.'auto/couleur_objet/v0.6.1/base/couleur_objet.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/base/medias.php');
include_once_check(_ROOT_PLUGINS.'auto/accesrestreint/v4.2.2/base/accesrestreint.php');
$inc=true;
}
...
$val = minipipe('import_ics_declarer_tables_auxiliaires', $val);
$val = minipipe('couleur_objet_declarer_tables_auxiliaires', $val);
...
$val = minipipe('Zcore_declarer_url_objets', $val);
return $val;
}
...
$val = minipipe('oembed_formulaire_charger', $val);
return $val;
}
...
if (!$inc){
include_once_check(_ROOT_PLUGINS.'pages/pages_pipelines.php');
include_once_check(_ROOT_PLUGINS.'contact/contact_pipelines.php');
include_once_check(_ROOT_PLUGINS.'mailsubscribers/mailsubscribers_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.52.0/saisies_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/cextras/v3.14.2/cextras_pipelines.php');
$inc=true;
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'facteur/facteur_pipelines.php');
include_once_check(_ROOT_PLUGINS.'mailsubscribers/mailsubscribers_pipelines.php');
include_once_check(_ROOT_PLUGINS.'agenda-v3/agenda_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/cextras/v3.14.2/cextras_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/videos/v0.12.9/videos_pipelines.php');
$inc=true;
}
$val = minipipe('facteur_formulaire_fond', $val);
$val = minipipe('mailsubscribers_formulaire_fond', $val);
$val = minipipe('agenda_formulaire_fond', $val);
$val = minipipe('cextras_formulaire_fond', $val);
$val = minipipe('videos_formulaire_fond', $val);
return $val;
}
...
if (!$inc){
include_once_check(_ROOT_PLUGINS_DIST.'statistiques/stats_pipelines.php');
include_once_check(_ROOT_PLUGINS.'scssphp/scssphp_pipelines.php');
$inc=true;
}
$val = minipipe('stats_formulaire_admin', $val);
$val = minipipe('scssphp_formulaire_admin', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'organiseur/organiseur_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'porte_plume/porte_plume_pipelines.php');
include_once_check(_ROOT_PLUGINS.'sociaux/sociaux_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.52.0/saisies_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'compresseur/compresseur_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/videos/v0.12.9/videos_pipelines.php');
$inc=true;
...
$val = minipipe('oembed_insert_head_css', $val);
return $val;
}
...
$val = minipipe('Zcore_insert_head', $val);
$val = minipipe('saisies_insert_head', $val);
$val = minipipe('compresseur_insert_head', $val);
$val = minipipe('scssphp_insert_head', $val);
$val = minipipe('oembed_insert_head', $val);
$val = minipipe('videos_insert_head', $val);
return $val;
}
...
$val = minipipe('Zcore_insert_head_css', $val);
$val = minipipe('sociaux_insert_head_css', $val);
$val = minipipe('agenda_insert_head_css', $val);
$val = minipipe('oembed_insert_head_css', $val);
$val = minipipe('videos_insert_head_css', $val);
return $val;
}
...
$val = minipipe('videos_jquery_plugins', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'mailsubscribers/mailsubscribers_pipelines.php');
include_once_check(_ROOT_PLUGINS.'mailshot-v1/mailshot_pipelines.php');
include_once_check(_ROOT_PLUGINS.'newsletters-v1/newsletters_pipelines.php');
include_once_check(_ROOT_PLUGINS.'agenda-v3/agenda_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/import_ics/v4.8.0/import_ics_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/breves_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/base/medias.php');
...
$val = minipipe('mailshot_optimiser_base_disparus', $val);
$val = minipipe('newsletters_optimiser_base_disparus', $val);
$val = minipipe('agenda_optimiser_base_disparus', $val);
$val = minipipe('import_ics_optimiser_base_disparus', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'svp/svp_pipelines.php');
include_once_check(_ROOT_PLUGINS.'pages/pages_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/accesrestreint/v4.2.2/public/accesrestreint.php');
$inc=true;
}
...
$val = minipipe('Zcore_pre_propre', $val);
$val = minipipe('oembed_pre_propre', $val);
return $val;
}
// Pipeline pre_liens 
...
$val = minipipe('oembed_pre_liens', $val);
return $val;
}
...
$val = minipipe('oembed_post_typo', $val);
return $val;
}
...
$val = minipipe('import_ics_post_edition', $val);
$val = minipipe('medias_post_edition', $val);
$val = minipipe('oembed_post_edition', $val);
$val = minipipe('accesrestreint_post_edition', $val);
return $val;
}
...
$val = minipipe('import_ics_post_edition_lien', $val);
return $val;
}
...
$val = minipipe('agenda_propres_creer_chaine_url', $val);
return $val;
}
...
$val = minipipe('import_ics_taches_generales_cron', $val);
return $val;
}
...
$val = minipipe('accesrestreint_rechercher_liste_des_champs', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'court-circuit/courtcircuit_ieconfig_metas.php');
include_once_check(_ROOT_PLUGINS.'facteur/facteur_ieconfig_metas.php');
include_once_check(_ROOT_PLUGINS.'contact/contact_ieconfig_metas.php');
...
$val = minipipe('agenda_revisions_chercher_label', $val);
...
// Pipeline sociaux_lister 
function execute_pipeline_sociaux_lister(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'sociaux/sociaux_pipelines.php');
$inc=true;
}
$val = minipipe('sociaux_sociaux_lister', $val);
return $val;
}
...
// Pipeline newsletter_pre_envoi 
function execute_pipeline_newsletter_pre_envoi(&$val){
return $val;
}
// Pipeline verifier 
...
// Pipeline saisie_est_fichier 
function execute_pipeline_saisie_est_fichier(&$val){
return $val;
}
...
// Pipeline saisies_lister_categories 
function execute_pipeline_saisies_lister_categories(&$val){
return $val;
}
...
// Pipeline saisies_afficher_si_saisies 
...
$val = minipipe('agenda_corbeille_table_infos', $val);
$val = minipipe('import_ics_corbeille_table_infos', $val);
return $val;
}
...
$val = minipipe('import_ics_declarer_champs_extras', $val);
return $val;
}
...
function execute_pipeline_evenement_liaisons_colonne_gauche(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/import_ics/v4.8.0/import_ics_pipelines.php');
$inc=true;
}
$val = minipipe('import_ics_evenement_liaisons_colonne_gauche', $val);
return $val;
}
// Pipeline evenement_ical_to_sql 
function execute_pipeline_evenement_ical_to_sql(&$val){
$val = minipipe('import_ics_evenement_ical_to_sql', $val);
return $val;
}
...
$val = minipipe('oembed_renseigner_document_distant', $val);
return $val;
}
...
function execute_pipeline_scss_variables(&$val){
return $val;
}
// Pipeline oembed_lister_providers 
function execute_pipeline_oembed_lister_providers(&$val){
return $val;
}
// Pipeline oembed_liste_arguments 
function execute_pipeline_oembed_liste_arguments(&$val){
return $val;
}
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/accesrestreint/v4.2.2/inc/accesrestreint.php');
$inc=true;
}
...
function execute_pipeline_accesrestreint_liste_objets_exclus(&$val){
return $val;
}
// Pipeline accesrestreint_repertoires_toujours_autorises 
function execute_pipeline_accesrestreint_repertoires_toujours_autorises(&$val){
return $val;
}
// Pipeline accesrestreint_pre_vue_document 
function execute_pipeline_accesrestreint_pre_vue_document(&$val){
return $val;
}
// Pipeline accesrestreint_afficher_document 
function execute_pipeline_accesrestreint_afficher_document(&$val){
return $val;
}
// Pipeline accesrestreint_objets_accessibles_where 
function execute_pipeline_accesrestreint_objets_accessibles_where(&$val){
return $val;
}
// Pipeline accesrestreint_objet_restreint 
function execute_pipeline_accesrestreint_objet_restreint(&$val){
return $val;
}
}
?>